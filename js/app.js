(() => {
    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                } else if (formRequiredItem.name === "phone") {
                    let phoneNumber = formRequiredItem.value;
                    let phoneRegex = /^\+380 \d{2} \d{3} \d{4}$/;
                ...
                if (error === 0) {
                    ...
                    if (ajax) {
                        ...
                        grecaptcha.ready(async function() {
                            grecaptcha.execute('6LciolQqAAAAACEuJM7w1DaOj8xG9auKO6mdJv1q', {action: 'submit'}).then(async function(token) {
    ...
    const newURL = `/order.html?${queryString}`
    ...
    window.location.href = newURL;
        ...
        da.init();
        let betas = document.querySelectorAll(".menu__list li");
        for (let beta of betas) beta.onclick = function() {
            document.documentElement.classList.remove("menu-open");
            document.documentElement.classList.remove("lock");
        };
        let scrollingLinks = document.querySelectorAll("[data-toScroll]");
        console.log(scrollingLinks);
        for (let scrollingLink of scrollingLinks) scrollingLink.onclick = function() {
            let scrollElement = document.getElementById(scrollingLink.dataset.toscroll);
            let scrollFunc = () => {
        ...
        const endDate = new Date("Jan 1, 2070 00:00:00").getTime();
        const hoursDOM = document.querySelector(".hours"), minutesDOM = document.querySelector(".minutes"), secondsDOM = document.querySelector(".seconds");
        setInterval((function() {
            ...
            hoursDOM.textContent = hours >= 10 ? hours : `0${hours}`;
            minutesDOM.textContent = minutes >= 10 ? minutes : `0${minutes}`;
            secondsDOM.textContent = seconds >= 10 ? seconds : `0${seconds}`;
